  ...
  return <section id="home" className="hero section">
    <div className="container hero-grid">
      <div className="hero-copy">
        <p className="eyebrow"><span /> ERP Technical Consulting</p>
        <h1>{profile.name}<em>{profile.title}</em></h1>
        <p className="hero-role">{profile.role}</p>
        <p className="hero-intro">{profile.intro}</p>
        <div className="hero-actions"><a className="button button-primary" href="#experience">View My Experience <ArrowRight size={17} /></a><a className="button button-quiet" href="#contact">Contact Me <ArrowDownRight size={17} /></a></div>
      </div>
      <div className="system-visual" aria-label="Illustration representing connected ERP systems">
        <div className="visual-top"><span>ERP OPERATIONS</span><i>LIVE</i></div>
        ...
        <div className="visual-footer"><span>MANUFACTURING</span><span>•</span><span>TECHNOLOGY</span><span>•</span><span>OUTCOMES</span></div>
      </div>
    </div>
  </section>
}
