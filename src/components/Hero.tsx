  ...
  return <section id="home" className="hero section">
    <div className="container hero-grid">
      <div className="hero-copy">
        ...
        <div className="hero-actions"><a className="button button-primary" href="#projects">View My Work <ArrowRight size={17} /></a>{resumeLink && <a className="button button-quiet" href={resumeLink}>Download Resume <ArrowDownRight size={17} /></a>}<a className="button button-quiet" href="#contact">Contact Me <ArrowDownRight size={17} /></a></div>
      </div>
      <div className="system-visual" role="img" aria-label="Illustration representing connected enterprise systems">
        <div className="visual-top"><span>ERP SYSTEMS</span><i>CORE</i></div>
        <div className="visual-core"><Settings2 size={39} strokeWidth={1.45}/><strong>SyteLine</strong><small>Enterprise Core</small></div>
        <div className="visual-node node-one"><Database size={18}/><span>SQL SERVER</span></div>
        <div className="visual-node node-two"><Network size={18}/><span>INTEGRATION</span></div>
        <div className="visual-node node-three"><span className="node-dot"/><span>IDOs / EVENTS</span></div>
